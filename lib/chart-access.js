...
(function() {
  ...
  class ChartAccess {
    constructor(apiClient = null, orderContext = null) {
      ...
      // Flag to prevent line recreation during drag
    ...
    handleLineDragged(lineType, newPrice) {
      try {
        // Set dragging flag to prevent line recreation
    ...
    /**
     * Check if currently dragging a line
     * @returns {boolean}
     */
    isCurrentlyDragging() {
     ...
     */
    hasLines() {
      return this.lines.stopLoss !== null || this.lines.takeProfit !== null;
    }
  }
